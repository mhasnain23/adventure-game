...
console.log(chalk.yellow.bold.italic("-----------------------Welcome to My Adventure Game!--------------------"));
class Player {
    name;
    health = 100;
    constructor(name) {
    ...
    if (opponents.select === "Zombie") {
        ...
        if (ask.options === "Attack") {
            ...
            if (num > 0) {
                ...
                console.log(chalk.red.bold(`${player1.name} health is ${player1.health}`));
                console.log(chalk.green.bold(`${opponent1.name} health is ${opponent1.health}`));
                if (player1.health <= 0) {
            ...
            if (num <= 0) {
                ...
                console.log(chalk.green.bold(`${player1.name} health is ${player1.health}`));
                console.log(chalk.red.bold(`${opponent1.name} health is ${opponent1.health}`));
        ...
        if (ask.options === "Drink Potion") {
            ...
            console.log(chalk.bold.italic.yellow(`Your drink health potion your fuel ${player1.health} `));
        }
